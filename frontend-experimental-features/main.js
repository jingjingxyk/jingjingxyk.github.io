...

{
    ...
    link.setAttribute('href', "https://www.jingjingxyk.com/ajax/libs/highlight.js/11.6.0/styles/default.min.css")
...
}
{
    ...
    link.setAttribute('charset', "utf-8")
    link.setAttribute('type', "text/css")
    link.setAttribute('href', "https://www.jingjingxyk.com/ajax/libs/highlight.js/11.6.0/styles/monokai-sublime.min.css")
    document.head.appendChild(link)
}
